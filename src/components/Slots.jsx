                ...
                <div className="grid justify-center grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 mt-5 sm:mt-10 lg:mt-[60px] relative gap-6 sm:gap-8 xl:gap-0">
                    <div className="flex justify-center xl:justify-start">
                        <div className="flex flex-col items-center w-full max-w-[245px]">
                            <span><SlotIcon1 /></span>
                            <h2 className="text-[#00141B] font-Anton font-normal text-lg sm:text-xl leading-[26px] text-center mt-4">Inteligencia</h2>
                            <p className="text-[#00141B] font-Inter font-medium text-sm sm:text-base opacity-80 md:leading-[26px] text-center mt-2 xs:mt-3 sm:mt-4">Comprendemos a la perfección los gustos de las personas y el mundo del gaming.</p>
                        </div>
                    </div>
                    <div className="flex justify-center xl:justify-center">
                        <div className="flex flex-col items-center w-full max-w-[245px]">
                            <span><SlotIcon2 /></span>
                            <h2 className="text-[#00141B] font-Anton font-normal text-lg sm:text-xl leading-[26px] text-center mt-4">Proactividad</h2>
                            <p className="text-[#00141B] font-Inter font-medium text-sm sm:text-base opacity-80 md:leading-[26px] text-center mt-2 xs:mt-3 sm:mt-4">Somos creadores de cambios que exploran nuevas formas de entretenimiento.</p>
                        </div>
                    </div>
                    <div className="flex justify-center sm:col-span-2 xl:col-span-1 xl:justify-end">
                        <div className="flex flex-col items-center w-full max-w-[245px] justify-center">
                            <span><SlotIcon3 /></span>
                            <h2 className="text-[#00141B] font-Anton font-normal text-lg sm:text-xl leading-[26px] text-center mt-4">Innovación</h2>
                            <p className="text-[#00141B] font-Inter font-medium text-sm sm:text-base opacity-80 md:leading-[26px] text-center mt-2 xs:mt-3 sm:mt-4">Pensamos fuera de la caja para estar siempre un paso adelante.</p>
                        </div>
                    </div>
