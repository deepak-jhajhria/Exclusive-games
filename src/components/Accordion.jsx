    ...
    return (
        <div className="relative ">
            <div className="container max-w-[970px] mt-10 sm:mt-16 md:mt-24 lg:mt-[150px]">
                <h2 data-aos="fade-up" data-aos-duration="500" className='text-white font-Anton font-normal text-center leading-8 md:leading-[69px] text-3xl sm:text-4xl md:text-5xl uppercase'>Preguntas más frecuentes</h2>
                <div className="my-6 sm:my-10 lg:my-[60px]">
                    {accordionData.map((item, index) => (
                        <div data-aos="fade-up" data-aos-duration="400" className={`border border-[#7E8D8F] mb-4 sm:mb-6 md:mb-8 rounded-md`} key={item.title}>
