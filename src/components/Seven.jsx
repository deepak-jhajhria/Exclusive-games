        ...
        <div className='relative'>
            <div className="container max-w-[1140px] pb-5 relative z-30">
                <div className="grid items-center xl:pt-[92px] xl:grid-cols-2 gap-9">
                    <div data-aos="fade-up" data-aos-duration="500" className='order-2 xl:order-1'>
                    ...
                    <div className='flex flex-col order-1 ml-2 -mt-10 xl:order-2 sm:mt-0'>
                        <h2 data-aos="fade-up" data-aos-duration="500" className='text-3xl sm:text-4xl md:text-5xl font-normal font-Anton lg:leading-[57px] text-white pb-8'>Más  razones para elegirnos</h2>
                        <div className='flex flex-col gap-6 lg:flex-row xl:flex-col'>
                            {data.map((items, index) => (
                                <div key={index} className=' bg-gradient-to-br from-[#51C8EF] to-[#7AF57A] max-w-[374px] rounded-2xl'>
                                    <div data-aos="fade-up" data-aos-duration="400" className='flex items-center py-6 px-5 xs:px-8 lg:px-14 bg-gradient-to-r from-[#051C20] to-[#051C22] m-[0.7px] rounded-2xl'>
                                        <span data-aos="fade-up" data-aos-duration="500">{items.svg}</span>
                                        <div className='flex flex-col ml-9'>
                                            <p data-aos="fade-up" data-aos-duration="500" className='font-normal font-Anton text-2xl sm:text-[32px] leading-10 text-white'>{items.number}</p>
                                            <p data-aos="fade-up" data-aos-duration="500" className='text-sm font-medium leading-6 text-white sm:text-base font-Inter'>{items.para}</p>
                                        </div>
                                    </div>
                                </div>
                            ))
