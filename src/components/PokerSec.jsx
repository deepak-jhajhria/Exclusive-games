            ...
            <div className="container -mt-4 max-w-[1140px] pb-8 sm:pb-12 md:pb-20 lg:pb-[100px] relative z-30">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 sm:gap-10 md:gap-[64px] w-full">
                    <div className="flex flex-col">
                        <div className='order-2 md:order-1' data-aos="fade-up" data-aos-duration="500"><img className='w-[90%] mx-auto md:w-full rounded-2xl' src={img1} alt="poker with friends" /></div>
                        <div className='flex flex-col max-sm:mb-7 max-md:mb-10 md:mt-[60px] max-w-[444px] order-0 md:order-2'>
                            ...
                            <p data-aos="fade-up" data-aos-duration="500" className='text-[#7AF57A] cursor-pointer text-base font-Inter font-bold mt-4 sm:mt-5 md:mt-6'>Aprende más {'-->'} </p>
                        </div>
                    </div>
                    <div className="flex flex-col">
                        ...
                        <div data-aos="fade-up" data-aos-duration="500"><img className='w-[90%] mx-auto md:w-full rounded-2xl' src={img2} alt="poker with friends" /></div>
                    </div>
                </div>
            </div>
